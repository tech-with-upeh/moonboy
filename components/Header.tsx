  ...
  return (
    <header className="px-6 pt-8 md:px-10 md:pt-10">
      <div className="mx-auto max-w-page">
        <div className="grid items-center gap-4 md:grid-cols-[150px_minmax(0,1fr)_150px] md:gap-8">
          <div className="relative hidden h-48 md:block">
            <Image src="/left.png" alt="Decorative left flourish" fill className="object-contain" sizes="150px" priority />
          </div>

          <div className="min-w-0">
            <div className="flex justify-center">
              <Image src="/butterflyh.png" width={80} height={80} alt="Dragonfly mark" className="h-20 w-20 md:h-24 md:w-24" priority />
            </div>
          ...
          <div className="relative hidden h-48 md:block">
            <Image src="/right.png" alt="Decorative right flourish" fill className="object-contain" sizes="150px" priority />
          </div>
        </div>
